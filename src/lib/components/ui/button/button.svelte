  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        outline:
          'bg-background shadow-xs hover:bg-primary hover:text-accent-foreground border border-primary/20',
        secondary: 'bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80',
        ghost: 'hover:bg-primary hover:text-accent-foreground dark:hover:bg-foreground/80',
        link: 'text-primary underline-offset-4 hover:underline',
        'no-background': 'bg-transparent transition-transform hover:text-primary/80'
      },
      size: {
